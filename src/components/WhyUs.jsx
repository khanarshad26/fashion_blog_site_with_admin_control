          ...
          <div className="row">
            <div className="col-lg-4 d-flex align-items-stretch">
              <div className="content">
                ...
                proper practical knowledge and industrial exposure through Events & Technical Events
                </p>
                <div className="text-center">
                <Link to='/about' style={{textDecoration: 'none'}} className="more-btn">Learn More <i className="bx bx-chevron-right" /></Link>
                </div>
              </div>
            </div>
                ...
                <div className="row">
                  ...
                  <div className="col-xl-4 d-flex align-items-stretch">
                    <div className="icon-box mt-4 mt-xl-0">
                      ...
                      <h4>Technical Events and sessions</h4>
